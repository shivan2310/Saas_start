            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                >
                  <div className="flex w-full items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <div className="p-2 rounded-md bg-[#4FAFB6]/10 text-[#4FAFB6]">
                        <Droplets className="h-4 w-4" />
                      </div>
                      <span className="text-[14px] font-semibold text-dash-text">Aqua</span>
                    </div>
                    {theme === "aqua" && (
                      <span className="flex h-5 w-5 items-center justify-center rounded-full bg-dash-accent text-white text-xs">
                        <Check className="h-3 w-3" />
                  ...
                  <p className="text-[12px] text-dash-text-muted">
                    Calm, fresh coastal light theme with crisp seafoam and cyan accents.
                  </p>
                  <div className="mt-4 w-full h-12 rounded border border-[#D7E9EA] bg-[#F5FAFA] p-2 flex items-center gap-2">
                ...
                >
                  <div className="flex w-full items-center justify-between mb-3">
                    <div className="flex items-center gap-2">
                      <div className="p-2 rounded-md bg-[#52B788]/10 text-[#52B788]">
                        <TreePine className="h-4 w-4" />
                      </div>
                      <span className="text-[14px] font-semibold text-dash-text">Forest</span>
                    </div>
                    {theme === "forest" && (
                      <span className="flex h-5 w-5 items-center justify-center rounded-full bg-dash-accent text-dash-background text-xs">
                        <Check className="h-3 w-3" />
                  ...
                  <p className="text-[12px] text-dash-text-muted">
                    Deep, natural dark theme with a focused, premium pine aesthetic.
                  </p>
                  <div className="mt-4 w-full h-12 rounded border border-[#293B31] bg-[#0B120E] p-2 flex items-center gap-2">
